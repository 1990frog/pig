...
public class UserController {
	...
	public R info() {
		return R.ok(userService.getUserInfo(null));
	}
	...
	public R info(@PathVariable String username) {
		return R.failed("缺少必要的参数sysClass");
	}
	 ...
	 */
	@Inner
	//@SSOUserInfo(userName = "#username", sysClass = "#sysClass")
	...
	public R userNew(@PathVariable String username, @PathVariable String sysClass) {
		...
		return R.ok(userService.getUserDetails(condition));
	}
