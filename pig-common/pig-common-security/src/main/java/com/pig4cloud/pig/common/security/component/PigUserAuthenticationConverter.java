...
public class PigUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			String sysClass = (String) map.get(SecurityConstants.DETAILS_SYS_CLASS);
			PigUser user = new PigUser(id, deptId,sysClass, username, N_A, true, true, true, true, authorities);
